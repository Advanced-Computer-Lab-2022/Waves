...
function addCourse(body,session) {
    const newCourse = new Courses({
        title: body.courseTitle,
        subtitles: [{name:body.courseSubtitles[0],exercise:body.examQuestions[0],videoLink:body.subtitleVideos[0] , description:body.subtitleDescriptions[0]},{name:body.courseSubtitles[1],exercise:body.examQuestions[1],videoLink:body.subtitleVideos[1] , description:body.subtitleDescriptions[1]},{name:body.courseSubtitles[2],exercise:body.examQuestions[2],videoLink:body.subtitleVideos[2] , description:body.subtitleDescriptions[2]}],
        ...
        givenBy: "session",
        chapters: [{name:body.courseSubtitles[0],exercise:body.examQuestions[0],videoLink:body.subtitleVideos[0] , description:body.subtitleDescriptions[0]},{name:body.courseSubtitles[1],exercise:body.examQuestions[1],videoLink:body.subtitleVideos[1] , description:body.subtitleDescriptions[1]},{name:body.courseSubtitles[2],exercise:body.examQuestions[2],videoLink:body.subtitleVideos[2] , description:body.subtitleDescriptions[2]}] //recently added
