...
const Info = (props: any) => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:3001/getEmail", { withCredentials: true })
      .then((response) => {
        setEmail(response.data);
      });

    axios
      .get("http://localhost:3001/getBio", { withCredentials: true })
      .then((response) => {
...
console.log(ratings[1]+"++---+"+type);
  ...
  function updateInfo() {
    if (newEmail != "" && isEmail) {
      ...
      axios
        .put(
          "http://localhost:3001/updateEmail",
          {
            user: username,
            email: newEmail,
          },
      ...
      <Stack direction="row">
        <Stack marginLeft={'auto'} marginRight={'auto'}>
          ...
          >
              ...
              <Stack sx={{ alignItems: "center" }} marginTop={2}>
                ...
                >
                  <Avatar
                    ...
                    style={
                      profilePicHover
                        ? { transition: ".3s ease", filter: "blur(2px)" }
                        : { transition: ".3s ease" }
                    }
                    onMouseEnter={() => {
                    ...
                    sx={{ position: "absolute", width: 125, height: 125 }}
                    alt="Remy Sharp"
                    src={profilePic}
                  />
                  <input
            ...
            <Button
              style={{ marginLeft: "38%", marginTop: "5vh" }}
              color="primary"
              variant="contained"
              onClick={() => {
                updateInfo();
