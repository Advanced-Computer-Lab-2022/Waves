...
const AddCourse = (props: any) => {
  const handleSubmit = (e: any) => {
    ...
    const subtitle1Video = Object.fromEntries(
      userInfo.entries()
    ).subtitle1Video;
    const subtitle1VideoDescription = Object.fromEntries(
      userInfo.entries()
    ).subtitle1VideoDescription;
    const subtitle2 = Object.fromEntries(userInfo.entries()).subtitle2;
    const subtitle2Video = Object.fromEntries(
      userInfo.entries()
    ).subtitle2Video;
    const subtitle2VideoDescription = Object.fromEntries(
      userInfo.entries()
    ).subtitle2VideoDescription;
    const subtitle3 = Object.fromEntries(userInfo.entries()).subtitle3;
    const subtitle3Video = Object.fromEntries(
      userInfo.entries()
    ).subtitle3Video;
    const subtitle3VideoDescription = Object.fromEntries(
      userInfo.entries()
    ).subtitle3VideoDescription;
    ...
    const subtitles = [
      [subtitle1, subtitle1VideoDescription],
      [subtitle2, subtitle2VideoDescription],
      [subtitle3, subtitle3VideoDescription],
    ];
