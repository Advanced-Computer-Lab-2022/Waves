                        ...
                        <Box sx={{ flexGrow: 0 }}>
                            {isNotLoggedIn ?
                                <Stack justifySelf={'end'} spacing={3} direction='row'>
                                    <Button color='secondary' variant='outlined' onClick={() => { navigate('../login') }}>Login</Button>
                                    <Button color='secondary' variant='outlined' onClick={() => { navigate('../signup') }}>Sign Up</Button>
                                </Stack> :
