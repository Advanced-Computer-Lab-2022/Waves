...
const FilterBar: React.FC<props> = ({
  ...
  function handleSubjectChange() {
    const arr = [];
    if (computerScience) arr.push("Computer Science");
    if (math) {
      arr.push("Math");
    }
    if (physics) {
  ...
  const onFilterChange = () => {
    axios
      .post(
        "http://localhost:3001/filterCourses",
        {
          rating: rating,
      ...
      >
        ...
        <Collapse in={subjectOpen && filterOpen} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            <FormControlLabel
              ...
              sx={{ pl: 8 }}
              control={<Checkbox checked={computerScience} />}
        ...
        <Collapse in={subjectOpen && filterOpen} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            <FormControlLabel
              ...
              sx={{ pl: 8 }}
              control={<Checkbox checked={physics} />}
              label="Physics"
            />
          </List>
        </Collapse>
        ...
        >
          <List component="div" disablePadding>
            <Stack
              ...
              onMouseEnter={() => setFourRatingHover(true)}
              onMouseLeave={() => setFourRatingHover(false)}
              spacing={1}
              direction="row"
              onClick={() => {
                if (!fourRating) {
              ...
              <Rating
                ...
                sx={{
                  "& .MuiRating-iconFilled": {
                    color:
                      fourRating || fourRatingHover ? "#F59200" : "#F5B100",
                  },
                  pl: 8,
                }}
                size={fourRating || fourRatingHover ? "large" : "medium"}
                name="read-only"
                value={4}
                readOnly
              />
              <Typography
                color={fourRating || fourRatingHover ? "#F59C00" : "black"}
                fontSize={fourRating || fourRatingHover ? 20 : 16}
              >
                {" "}
                & Up{" "}
              </Typography>
        ...
        >
          <List component="div" disablePadding>
            <Stack
              className="pointer-link"
              onMouseEnter={() => setThreeRatingHover(true)}
              onMouseLeave={() => setThreeRatingHover(false)}
              spacing={1}
              direction="row"
              onClick={() => {
                if (!threeRating) {
            ...
            >
              <Rating
                ...
                sx={{
                  "& .MuiRating-iconFilled": {
                    color:
                      threeRating || threeRatingHover ? "#F59200" : "#F5B100",
                  },
                  pl: 8,
                }}
                size={threeRating || threeRatingHover ? "large" : "medium"}
                name="read-only"
                value={3}
                readOnly
              />
              <Typography
                color={threeRating || threeRatingHover ? "#F59C00" : "black"}
                fontSize={threeRating || threeRatingHover ? 20 : 16}
              >
                {" "}
                & Up{" "}
              </Typography>
        ...
        >
          <List component="div" disablePadding>
            <Stack
              className="pointer-link"
              onMouseEnter={() => setTwoRatingHover(true)}
              onMouseLeave={() => setTwoRatingHover(false)}
              spacing={1}
              direction="row"
              onClick={() => {
                if (!twoRating) {
            ...
            >
              <Rating
                ...
                sx={{
                  "& .MuiRating-iconFilled": {
                    color: twoRating || twoRatingHover ? "#F59200" : "#F5B100",
                  },
                  pl: 8,
                }}
                size={twoRating || twoRatingHover ? "large" : "medium"}
                name="read-only"
                value={2}
                readOnly
              />
              <Typography
                color={twoRating || twoRatingHover ? "#F59C00" : "black"}
                fontSize={twoRating || twoRatingHover ? 20 : 16}
              >
                {" "}
                & Up{" "}
              </Typography>
        ...
        >
          <List component="div" disablePadding>
            <Stack
              className="pointer-link"
              onMouseEnter={() => setOneRatingHover(true)}
              onMouseLeave={() => setOneRatingHover(false)}
              spacing={1}
              direction="row"
              onClick={() => {
                if (!oneRating) {
            ...
            >
              <Rating
                ...
                sx={{
                  "& .MuiRating-iconFilled": {
                    color: oneRating || oneRatingHover ? "#F59200" : "#F5B100",
                  },
                  pl: 8,
                }}
                size={oneRating || oneRatingHover ? "large" : "medium"}
                name="read-only"
                value={1}
                readOnly
              />
              <Typography
                className="growN"
                color={oneRating || oneRatingHover ? "#F59C00" : "black"}
                fontSize={oneRating || oneRatingHover ? 20 : 16}
              >
                {" "}
                & Up{" "}
              </Typography>
          ...
          <List component="div" disablePadding>
            <ListItem sx={{ pl: 8 }}>
              <Box sx={{ width: 300 }}>
                <Stack
                  direction={"row"}
                  sx={{ marginLeft: 2.5, width: 200, marginBottom: 3 }}
                >
                  <FormControl
                    fullWidth
                    variant="standard"
